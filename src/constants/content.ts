...
export const DOC_URL = {
  documentationUrl: 'https://dev.fingerprint.com/docs',
  getStartedUrl: 'https://dev.fingerprint.com/docs/quick-start-guide',
  proVsOpenUrl: 'https://dev.fingerprint.com/docs/pro-vs-open-source',
  browserFingerprintUrl: 'https://dev.fingerprint.com/docs/browser-fingerprinting',
  incognitoUrl: 'https://dev.fingerprint.com/docs/incognito-private-mode-detection',
  serverApiUrl: 'https://dev.fingerprint.com/docs/server-api',
  legalUrl: 'https://dev.fingerprint.com/docs/dpa-gdpr',
  termOfUseUrl: 'https://dev.fingerprint.com/docs/terms-of-service',
  privacyPolicyUrl: 'https://dev.fingerprint.com/docs/privacy-policy',
  browserSupportUrl: 'https://dev.fingerprint.com/docs/browser-support',
  webhooksUrl: 'https://dev.fingerprint.com/docs/webhooks',
